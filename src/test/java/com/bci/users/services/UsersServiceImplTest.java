...
class UsersServiceImplTest {
    private static final String PASSWORD_ENCODED = "01234$2a$10$17hqjnQ6sHxLig7Nn8crneQWq9IlQcYAwA5VmRRL/2y.hUQemBZJC";
    ...
    public void createUser_userWithEmailAlreadyExists_throwsException () {
        ...
        var errorMessage = assertThrows(ConflictException.class,
                () -> usersService.createUser(getUserRequest(EMAIL))).getMessage();
    ...
    public void createUser_userWithEmailOrNameNotExists_created () {
        ...
        var responseExpected = UserResponse
                            .builder()
